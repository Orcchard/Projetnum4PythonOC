...
class ControllerPrincipal:
    ...
    def __init__(self):
        ...
        self.tournaments_file = "tournament_data.json"
    ...
    def new_tournament(self):
        ...
        self.participant_tournament.append(tournament)
    ...
    def save_tournaments(self):
        ...
        with open(self.tournaments_file, "w", encoding="utf-8") as file:
            json.dump([t.tournament_dict() for t in self.participant_tournament], file, indent=4)
            
    def load_tournaments(self):
        """Charge les tournois à partir du fichier JSON."""
        try:
            try:
                ...
                print("Erreur : fichier de données des tournois introuvable.")
                return []
        except Exception as e:
            print(f"Erreur lors du chargement du tournois : {e}")
            return []
        self.display_all_players_with_num_rank()
    ...
    def select_participants_tournament(self):
        """Sélectionne 8 joueurs en saisissant les 3 premières lettres du nom"""
